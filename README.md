...
Case 1 presented six tradable products, each with its own pricing mechanics, information structure, and opportunity set. Understanding how each asset was designed — and how bots and other teams would interact with it — was foundational to building a competitive algorithm.
